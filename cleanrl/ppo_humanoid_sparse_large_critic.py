...
@dataclass
class Args:
    exp_name: str = "ppo_humanoid_sparse_large_critic"
    seed: int = 1
    torch_deterministic: bool = True
    cuda: bool = True
    track: bool = False
    wandb_project_name: str = "cleanRL"
    wandb_run_name: str = "ppo_humanoid_sparse"
    ...
    total_timesteps: int = 120000000  # Humanoid needs more samples
...
class Agent(nn.Module):
    def __init__(self, envs):
        ...
        self.critic = nn.Sequential(
            layer_init(nn.Linear(obs_shape, 512)),  # increased from 256
            nn.Tanh(),
