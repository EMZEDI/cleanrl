# ppo_double_dm_control.py
# PPO with DOUBLE-SIZE networks for dm_control benchmarks.
# Architecture: 128-128 hidden layers (2x wider than standard PPO's 64-64).
# Purpose: ablation to show DART's gains come from the algorithm, not extra params.
# DART has ~3 networks of 64-64 (base critic + res critic + actor) while standard
# PPO has 2 networks of 64-64. This "double PPO" has 2 networks of 128-128, which
# actually exceeds DART's total parameter count, making it a fair+ comparison.
import os
import random
import time
